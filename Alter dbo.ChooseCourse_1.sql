USE [D:\SOFTWAREPROJ\STUMANAGE\DB_51ASPX\STUDENTMANAGER.MDF]
GO

/****** Object: SqlProcedure [dbo].[ChooseCourse] Script Date: 6/9/2020 23:20:40 ******/
SET ANSI_NULLS ON
GO
...
-- Description:学生选课
-- =============================================
ALTER PROCEDURE  [dbo].[ChooseCourse]
(
  @St_id varchar(20),
  @Pc_id bigint ,
  @Pc_year char(10),
