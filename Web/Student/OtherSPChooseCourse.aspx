<%@ Page Language="C#" MasterPageFile="~/Student/StudentMasterPage.master" AutoEventWireup="true" CodeFile="OtherSPChooseCourse.aspx.cs" Inherits="Student_OtherSPChooseCourse" Title="现代教务管理系统" %>
...
function ourSpChoose_onclick() {
location.replace('ChooseCourse.aspx');
}
                ...
                <table style="border-right: #99ccff 1px solid; border-top: #99ccff 1px solid;
                    ...
                    <tr>
                        <td colspan="6" style="border-right: #99ccff 0.1em solid; border-top: #99ccff 0.1em solid;
                            ...
                            <asp:DropDownList ID="ddlCollege" runat="server"  AutoPostBack="True" OnSelectedIndexChanged="ddlCollege_SelectedIndexChanged" Width="238px" OnDataBinding="ddlCollege_DataBinding">
                            </asp:DropDownList>
                            <asp:DropDownList ID="ddlSp" runat="server"  AutoPostBack="True" Width="256px" OnDataBinding="ddlSp_DataBinding">
                            </asp:DropDownList>
                            <asp:Button ID="viewCourse" runat="server" OnClick="viewCourse_Click" Text="查看课程" /></td>
                    </tr>
                    <tr>
                        <td colspan="6" rowspan="2" style="border-right: #99ccff 0.1em solid; border-top: #99ccff 0.1em solid;
                            border-left: #99ccff 0.1em solid; border-bottom: #99ccff 0.1em solid; height: 335px; width: 100%;" align="center" valign="top">
                    ...
                    <tr>
                        <td colspan="6" style="border-right: #99ccff 0.1em solid; border-top: #99ccff 0.1em solid;
                            border-left: #99ccff 0.1em solid; border-bottom: #99ccff 0.1em solid; height: 15px;
                            text-align: center; width: 100%;">
                            <input id="ourSpChoose" type="button" value="本专业选课" onserverclick="ourSpChoose_ServerClick" onclick="return ourSpChoose_onclick()" />
                            &nbsp; &nbsp; &nbsp;&nbsp;
