<%@ Page Language="C#" MasterPageFile="~/Department/MasterPage.master" AutoEventWireup="true" CodeFile="AfficheDetails.aspx.cs" Inherits="Guest_AfficheDetails" Title="现代教务管理系统" StylesheetTheme="Default" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
        <table  class="tbAffiche" style="width: 100%; height: 93%; border-right: #99ccff 1px solid; border-top: #99ccff 1px solid; border-left: #99ccff 1px solid; border-bottom: #99ccff 1px solid;font-family:Arial;color: #000000;font-size: 12px;" >
            <tr>
            ...
            <tr>
                <td style="width: 58px; height: 410px; vertical-align: top; text-align: right; border-right: #99ccff 0.1em solid; border-top: #99ccff 0.1em solid; border-left: #99ccff 0.1em solid; border-bottom: #99ccff 0.1em solid;">
                    公告内容:</td>
                <td style="height: 410px; vertical-align: top; text-align: left; border-right: #99ccff 0.1em solid; border-top: #99ccff 0.1em solid; border-left: #99ccff 0.1em solid; border-bottom: #99ccff 0.1em solid; width: 676px;">
                <% =dr["af_content"]%>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" style="background-image: url(Images/bottom_bg.gif); height: 24px;
                    text-align: right">
                    <%--
                        power &nbsp;by  &nbsp;&nbsp;
                        --%>       
