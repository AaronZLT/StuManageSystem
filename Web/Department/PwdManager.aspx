<%@ Page Language="C#" MasterPageFile="~/Department/DepartmentMasterPage.master" AutoEventWireup="true" CodeFile="PwdManager.aspx.cs" Inherits="Department_PwdManager" Title="现代教务管理系统" %>
        ...
        <tr>
            <td colspan="2" style="border-right: #99ccff 0px solid; border-top: #99ccff 0px solid;
                ...
                <table class="changePwd" style="border-right: #99ccff 0.05em solid; border-top: #99ccff 0.05em solid;
                    ...
                    <tr>
                        <td style="width: 192px; height: 25px; text-align: right">
                            修改对象:</td>
                        <td style="width: 278px; height: 25px; text-align: left">
                            <asp:DropDownList ID="ddlObject" runat="server" Width="139px">
                    ...
                    <tr style="color: #000000">
                        <td style="width: 192px; height: 25px; text-align: right">
                            编 &nbsp; &nbsp; &nbsp; 号:</td>
                        <td style="width: 278px; height: 25px; text-align: left">
                            <asp:TextBox ID="txtNumber" runat="server" Width="134px"></asp:TextBox>
                    ...
                    <tr style="color: #000000">
                        ...
                        <td style="width: 278px; height: 25px; text-align: left">
                            <asp:TextBox ID="txtNewPwd" runat="server" TextMode="Password" Width="134px"></asp:TextBox>
                    ...
                    <tr style="color: #000000">
                        <td style="width: 192px; height: 25px; text-align: right">
                            新 密 码:</td>
                        <td style="width: 278px; height: 25px; text-align: left">
                            <asp:TextBox ID="txtReNewPwd" runat="server" TextMode="Password" Width="134px"></asp:TextBox>
